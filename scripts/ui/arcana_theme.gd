...
## The world is land, not a panel: unclaimed ground reads as soil and moss.
const WORLD_GROUND := Color("#2b3327")
const WORLD_GROUND_ALT := Color("#313a2c")
const WORLD_EDGE := Color("#11150f")
