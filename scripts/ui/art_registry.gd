...
## Anchor landmarks: the one strange monument each built lane keeps
## (assets/art/board/anchors, generated by tools/generate_hero_art.py).
func anchor(element: String, variant: int) -> Texture2D:
    return _texture("res://assets/art/board/anchors/%s_anchor_%d.png" % [element, posmod(variant, 3)])
